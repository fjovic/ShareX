...
namespace ShareX.Forms
{
    public partial class MainForm : HotkeyForm
    {
        ...
        public MainForm()
        {
            ...
            {
                Program.Settings.SilentRun = true;
            }
        }
        ...
        private void InitHotkeys()
        {
            ...
            }).ContinueInCurrentContext(() =>
            {
                ...
                if (Program.Settings.LightMode)
                {
                    var lightModeInitialForm = new LightModeInitialForm();
                    lightModeInitialForm.Show();
                }
        ...
        {
            new CaptureRegion(RegionCaptureType.Light).Capture(true, true);
        }
        ...
        {
            new CaptureRegion(RegionCaptureType.Light).Capture(null, false, true);
        }
