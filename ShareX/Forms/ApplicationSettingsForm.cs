...
namespace ShareX.Forms
{
    public partial class ApplicationSettingsForm : Form
    {
        ...
        private void UpdateControls()
        {
            ...
            cbLightMode.Checked = Program.Settings.LightMode;
        ...
        private void cbLightMode_CheckedChanged(object sender, EventArgs e)
        {
            Program.Settings.LightMode = cbLightMode.Checked;
        }
